...
1. Under **Users may sync settings and app data across devices** you will be presented with three options such as **"All"** , **"Selected"** , **"None"**. "All" will enable this feature for All users in this tenant. "Selected" will require you to add Users or Groups. "None" will disable this feature. For more information, see [how to configure device settings](./manage-device-identities.md).
